...
<head>
    ...
    <title>Dashboard | CBC - Chengdu Bus Company</title>
                                                                                ...
                                                                                <a href="#">
                                                                                    <div class="project-list-flow">
                                                                                        <div class="projects-st-heading">
                                                                                            ...
                                                                                            <p>The username is Anna and the account is registered.</p>
                                                                                ...
                                                                                <a href="#">
                                                                                    <div class="project-list-flow">
                                                                                        <div class="projects-st-heading">
                                                                                            ...
                                                                                            <p> 15 economy tickets and 7 business tickets were booked.</p>
                                                                            ...
                                                                            <li>
                                                                                <a href="#">
                                                                                    <div class="project-list-flow">
                                                                                        <div class="projects-st-heading">
                                                                                            <h2>New Order Received</h2>
                                                                                            <p> User Muyan123 bought a Fried chicken combo and a coke.</p>
                                                                            ...
                                                                            <li>
                                                                                <a href="#">
                                                                                    <div class="project-list-flow">
                                                                                        <div class="projects-st-heading">
                                                                                            <h2>New Order Received</h2>
                                                                                            <p> 24 economy tickets were booked.</p>
                                                                            ...
                                                                            <li>
                                                                                <a href="#">
                                                                                    <div class="project-list-flow">
                                                                                        <div class="projects-st-heading">
                                                                                            <h2>New User</h2>
                                                                                            <p> The username is Jennis and the account is registered.</p>
                                                                            ...
                                                                            <li>
                                                                                <a href="#">
                                                                                    <div class="project-list-flow">
                                                                                        <div class="projects-st-heading">
                                                                                            <h2>New Order</h2>
                                                                                            <p> User Terit bought a luxury Chinese package.</p>
                                                            ...
                                                            <div id="Settings" class="tab-pane fade">
                                                                <div class="setting-panel-area">
                                                                    <div class="note-heading-indicate">
                                                                        ...
                                                                        <p> You have 7 Settings. 5 not completed.</p>
                                                                    </div>
